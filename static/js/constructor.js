...
var vacio = 0, fantasma = 0, robot = 0, dragon = 0, exiliado = 0, hextech = 0;
...
var arrayHechiero = ["Ahri", "AurelionSol", "Karthus", "Kassadin", "Lulu", "Morgana", "Veigar", "Twisted"];
...
var arrayPirata = ["Graves", "MissFortune", "Pyke", "Gangplank", "Twisted"];
...
var arrayDragon = ["Shyvana", "AurelionSol", "Pantheon"];
var arrayExiliado = ["Yasuo"];
var arrayHextech = ["Jinx", "Camille", "Jayce", "Vi"];
...
function select(arg) {
    ...
    var numHextech = document.getElementById("numHextech");

    img.style.filter = "grayscale(100%)";
    img.setAttribute("onclick", "deselect('" + arg + "');");
    var seleccionados = document.getElementById("seleccionados");
    seleccionados.innerHTML += "<img class='imagen grande' id=" + arg + "In onclick=deselect('" + arg + "') src='static/campeones/" + arg + ".png'>";
    ...
    if (arrayAsesinos.indexOf(arg) != -1) {
        ...
        if (espadachin > 0) {
            ...
            if (espadachin == 3) {
                ...
                div1.style.backgroundColor = "#c9aa71"
            } else if (espadachin == 9) {
                var div1 = document.getElementById("Espadachin3");
                div1.style.backgroundColor = "#c9aa71"
            }
        }
        ...
        if (luchador > 0) {
            ...
            if (luchador == 2) {
                ...
                var div1 = document.getElementById("Luchador3");
                div1.style.backgroundColor = "#c9aa71"
            }
        }
        ...
        if (cam > 0) {
            ...
            if (cam == 3) {
                ...
                var div1 = document.getElementById("Cam2");
                div1.style.backgroundColor = "#c9aa71"
            }
        }
        ...
        if (pistolero > 0) {
            ...
            if (pistolero == 2) {
                ...
                var div1 = document.getElementById("Pistolero3");
                div1.style.backgroundColor = "#c9aa71"
            }
        }
    }
    ...
    } if (arrayHextech.indexOf(arg) != -1) {
        hextech++;
        //Exiliado
        if (hextech > 0) {
            var clase = document.getElementById("Hextech");
            clase.classList.remove("byn");
            clase.classList.add("seleccionado");
            var div1 = document.getElementById("Hextech1");
            var div2 = document.getElementById("Hextech2");
            numHextech.innerHTML = hextech;
            if (hextech == 2) {
                div1.style.backgroundColor = "#c9aa71"
            } else if (hextech == 4) {
                div2.style.backgroundColor = "#c9aa71"
...
function deselect(arg) {
    ...
    if (arrayAsesinos.indexOf(arg) != -1) {
        ...
        if (espadachin == 0) {
            ...
            var div3 = document.getElementById("Espadachin3");
            if (espadachin < 3) {
                div1.removeAttribute("style");
            } else if (espadachin < 6) {
                div2.removeAttribute("style");
        ...
        if (luchador == 0) {
            ...
            var div3 = document.getElementById("Luchador3");
            if (luchador < 2) {
                div1.removeAttribute("style");
            } else if (luchador < 4) {
                div2.removeAttribute("style");
        ...
        if (cam == 0) {
            ...
            var div1 = document.getElementById("Cam1");
            var div2 = document.getElementById("Cam2");
            if (cam < 3) {
                div1.removeAttribute("style");
            }if (cam < 6) {
                div2.removeAttribute("style");
        ...
        if (pistolero == 0) {
            ...
            var div3 = document.getElementById("Pistolero3");
            if (pistolero < 2) {
                div1.removeAttribute("style");
            } else if (pistolero < 4) {
                div2.removeAttribute("style");
