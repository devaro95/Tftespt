...
<body id="inicio">
	<div style="display: block;">
		...
		<div id="menuNot">
			...
			<div style="display: flex;">
				<div id="leftColNot" style="background-image: url('static/originales/fondonoticia.png'); background-position:center;">
					<div
						>
						<div style="width: 100%;text-align: center">
							<img style="border:solid 1px black" src="fotos_noticias/<?php print ($datos['foto']);?>" />
